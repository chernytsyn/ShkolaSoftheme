...
namespace Lection_18
{
    ...
    {
        public List<MobileAccount> RegisteredAccounts { get; set; }
        public List<AccountInfo> InfoAboutAccounts { get;  set; }
        ...
        public void ForceSubcribe()
        {
            count = 0;
            for (var i = 0; i < RegisteredAccounts.Count-1; i++)
            {
                ObserveCallsAndSms();
            }
        }
